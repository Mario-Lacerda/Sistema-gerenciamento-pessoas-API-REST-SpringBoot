package dio.springboot.personapi.utils;
...
public class PersonUtils {
    ...
    private static final String CPF_NUMBER = "414.427.428-44";
    private static final long PERSON_ID = 1L;
    public static final LocalDate BIRTH_DATE = LocalDate.of(1991, 5, 3);
